 ...
 * Abre: http://localhost/NOMBRE-CARPETA/html/instalar.php
...
<p><a class="btn btn-primary" href="../auth/login.php">Ir a iniciar sesión</a></p>
<p class="hint">Administrador: admin@admin.cl / admin123 (servicios y productos)<br>Peluquero: Ricardo — ricardo@me.com / kako123<br>Cliente: ana / ana123</p>
<?php endif; ?>
